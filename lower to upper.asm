...
sub AL, 20h        ; sub 32 (20h) to convert uppercase to lowercase
MOV BL,AL
...
msg_input  DB 'Enter an lower case letter: $'
msg_output DB 0Dh, 0Ah, 'The uppercase letter is: $'  ; Output message
msg_error  DB 0Dh, 0Ah, 'Error: Not an lower case letter! $'  ; Error message
